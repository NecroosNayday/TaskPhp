    ...
    class Pagination{
        ...
        public function getHtml(){
            ...
            if($this->currentPage > 3){
                $startpage = "<li class='page-item'><a class='page-link' href='{$this->uri}page=l'>&laquo;</a></li>";
            }
            if($this->currentPage < ($this->countPages - 2)){
                $endpage = "<li class='page-item'><a class='page-link'
            ...
            return '<ul class="pagination justify-content-center mt-5">' .$startpage.$back.$page2left.$page1left.'<li class="page-item active"><a class="page-link">'.$this->currentPage.'<span class="sr-only">(current)</span></a></li>'.$page1right.$page2right.$forward.$endpage . '</ul>';
        }
